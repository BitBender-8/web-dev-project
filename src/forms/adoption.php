    ...
    <form action="../includes/adoption/adoption-formhandler.php" method="post" novalidate>
        ...
        <ul>
            <li>
                ...
                <input type="text" id="adopter1_first_name" name="adopter1_first_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter1_middle_name">Middle name:</label>
                <input type="text" id="adopter1_middle_name" name="adopter1_middle_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter1_last_name">Last name:</label>
                <input type="text" id="adopter1_last_name" name="adopter1_last_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" id="adopter1_birthplace" name="adopter1_birthplace" required
                    maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
                <label for="adopter1_citizenship">Country of citizenship:</label>
                <input type="text" id="adopter1_citizenship" name="adopter1_citizenship" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" id="adopter1_residence" name="adopter1_residence" required
                    maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
                <label for="adopter1_occupation">Occupation:</label>
                <input type="text" id="adopter1_occupation" name="adopter1_occupation" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter1_relationship_child">Relationship to Child (if any):</label>
                <input type="text" id="adopter1_relationship_child" name="adopter1_relationship_child"
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter1_relationship_adopter2">Relationship to adopter 2 (if applicable):</label>
                <input type="text" id="adopter1_relationship_adopter2" name="adopter1_relationship_adopter2"
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter1_relationship_chld_parent">Relationship to Child's Parent (if any):</label>
                <input type="text" id="adopter1_relationship_chld_parent" name="adopter1_relationship_chlds_parent"
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
        </ul>
        ...
        <ul>
            <li>
                ...
                <input type="text" id="adopter2_first_name" name="adopter2_first_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter2_middle_name">Middle name:</label>
                <input type="text" id="adopter2_middle_name" name="adopter2_middle_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter2_last_name">Last name:</label>
                <input type="text" id="adopter2_last_name" name="adopter2_last_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" id="adopter2_birthplace" name="adopter2_birthplace" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter2_citizenship">Country of citizenship:</label>
                <input type="text" id="adopter2_citizenship" name="adopter2_citizenship" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" id="adopter2_residence" name="adopter2_residence" required
                    maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
                <label for="adopter2_occupation">Occupation:</label>
                <input type="text" id="adopter2_occupation" name="adopter2_occupation" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter2_relationship_child">Relationship to Child (if any):</label>
                <input type="text" id="adopter2_relationship_child" name="adopter2_relationship_child"
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter2_relationship_adopter2">Relationship to adopter 1 (if applicable):</label>
                <input type="text" id="adopter2_relationship_adopter2" name="adopter2_relationship_adopter1"
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="adopter2_relationship_chld_parent">Relationship to Child's Parent (if any):</label>
                <input type="text" id="adopter2_relationship_parent" name="adopter2_relationship_chlds_parent"
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
        </ul>
        ...
        <ul>
            ...
            <input type="radio" id="adopter_category_default" name="adopter_category" value="" style="display: none;"
                required checked>
            <li>
                <input type="radio" id="adopter_category_stepparent" name="adopter_category" value="stepparent"
                    required>
            ...
            <li>
                <input type="radio" id="adopter_category_couple" name="adopter_category" value="couple" disabled
                    required>
                <label for="adopter_category_couple">Married Couple (requires both adopters)</label>
            </li>
            <li>
                <input type="radio" id="adopter_category_cohabitants" name="adopter_category" value="cohabitants"
                    disabled required>
            ...
            <li>
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" id="received_child_from" name="received_child_from"
                            maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
                    </li>
                    <li>
                        <label for="child_placer_address">Placement address:</label>
                        <input type="text" id="child_placer_address" name="child_placer_address"
                            maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
                    </li>
                    <li>
                        <label for="child_placer_phone">Phone:</label>
                        <input type="tel" id="child_placer_phone" name="child_placer_phone" required
                            pattern="<?=PHONE_REGEX;?>">
                    </li>
                </ul>
            </li>
        ...
        <fieldset>
            ...
            <!-- An empty radio button that ensures that a default value is submitted to the server. -->
            <input type="radio" id="adoption_type_default" name="adoption_type" value="" style="display: none;" required
                checked>
