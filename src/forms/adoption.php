...
<head>
    ...
    <script defer src="<?=PROJECT_ROOT?>src/public/js/adoption/adoption.js"></script>
    <!-- Styles -->
...
if (true || !empty($_SESSION["user_id"])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        ob_start();
        require_once "../includes/adoption/adoption-formhandler.php";
        $output = ob_get_clean();
        echo $output;
    }

    require_once "./adoption-form.php";
} else {
