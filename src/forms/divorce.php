...
<body>
    ...
    <form action="../includes/divorce/divorce-formhandler.php" method="post" enctype="multipart/form-data">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" id="spouse1_place_of_birth" name="spouse1_place_of_birth" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
                <label for="spouse1_residence">Principal Residence:</label>
                <input type="text" id="spouse1_residence" name="spouse1_residence" required
            ...
            <li>
                ...
                <input type="text" id="spouse1_citizenship" name="spouse1_citizenship" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
        </ul>
        <h2>Second spouse</h2>
        <ul>
            <li>
                ...
                <input type="text" id="spouse2_first_name" name="spouse2_first_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <li>
                ...
                <input type="text" id="spouse2_place_of_birth" name="spouse2_place_of_birth" required>
            </li>
            <li>
                <label for="spouse2_residence">Principal Residence:</label>
                <input type="text" id="spouse2_residence" name="spouse2_residence" required
                    maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" id="spouse2_citizenship" name="spouse2_citizenship" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
        </ul>
