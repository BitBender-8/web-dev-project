...
<head>
    ...
    <script defer src="<?=PROJECT_ROOT?>src/public/js/birth/birth.js"></script>
    <!-- Styles -->
    ...
    <title>Live Birth Registration Form</title>
</head>
<body>
    ...
    <div id="err-container"></div><div class="content">
        <h1>Live Birth registration form</h1>
<?php
if (!empty($_SESSION["user_id"])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        ob_start();
        require_once "../includes/birth/birth-formhandler.php";
        $output = ob_get_clean();
        echo $output;
    }

    require_once "./birth-form.php";
} else {
