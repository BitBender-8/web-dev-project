...
<body>
    ...
    <form action="../includes/birth/birth-formhandler.php" method="post">
        ...
        <fieldset>
            ...
            <input type="text" name="child_place_of_birth" id="child_place_of_birth" required
            ...
            <textarea name="child_aid_rendered" id="child_aid_rendered" rows="1"
        ...
        <fieldset>
            ...
            <input type="text" name="mother_middle_name" id="mother_middle_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="mother_place_of_birth" id="mother_place_of_birth" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            <label for="mother_residence">Principal Residence:</label>
            <input type="text" name="mother_residence" id="mother_residence" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            ...
            <input type="text" name="mother_citizenship" id="mother_citizenship" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <br>
        </fieldset>
        <fieldset>
            ...
            <input type="text" name="father_middle_name" id="father_middle_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="father_place_of_birth" id="father_place_of_birth" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            <label for="father_residence">Principal Residence:</label>
            <input type="text" name="father_residence" id="father_residence" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
        ...
        <input type="text" name="declarant_first_name" id="declarant_first_name"
            maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="declarant_middle_name">Middle Name:</label>
        <input type="text" name="declarant_middle_name" id="declarant_middle_name"
            maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="declarant_last_name">Last Name:</label>
        <input type="text" name="declarant_last_name" id="declarant_last_name"
            maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="declarant_relation_to_child">Relationship to Child (Enter none if you have no relationship to the
            child)</label>
        <input type="text" name="declarant_relation_to_child" id="declarant_relation_to_child"
        ...
        <input type="text" name="declarant_place_of_birth" id="declarant_place_of_birth"
            maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
