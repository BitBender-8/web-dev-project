...
<body>
    ...
    <form action="../includes/birth/birth-formhandler.php" method="post">
        ...
        <input type="text" name="child_first_name" id="child_first_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="child_middle_name">Middle Name</label>
        <input type="text" name="child_middle_name" id="child_middle_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="child_last_name">Last Name:</label>
        <input type="text" name="child_last_name" id="child_last_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        ...
        <fieldset>
            ...
            <input type="text" name="child_place_of_birth" id="child_place_of_birth" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            <br>
            ...
            <textarea name="child_aid_rendered" id="child_aid_rendered" rows="1" maxlength="<?=TEXTAREA_MAXLENGTH_SMALL;?>"></textarea>
        </fieldset>
        <h2>Parents' Information</h2>
        <fieldset>
            <legend>Mother's Information</legend>
            <label for="mother_first_name">First Name:</label>
            <input type="text" name="mother_first_name" id="mother_first_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="mother_middle_name">Middle Name:</label>
            <input type="text" name="mother_middle_name" id="mother_middle_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="mother_last_name">Last Name:</label>
            <input type="text" name="mother_last_name" id="mother_last_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="mother_place_of_birth" id="mother_place_of_birth" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            <label for="mother_residence">Principal Residence:</label>
            <input type="text" name="mother_residence" id="mother_residence" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            <label for="mother_phone">Phone number:</label>
            <input type="tel" name="mother_phone" id="mother_phone" required pattern="<?=PHONE_REGEX;?>">
            ...
            <input type="text" name="mother_citizenship" id="mother_citizenship" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <br>
        </fieldset>
        <fieldset>
            <legend>Father's Information</legend>
            <label for="father_first_name">First Name:</label>
            <input type="text" name="father_first_name" id="father_first_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="father_middle_name">Middle Name:</label>
            <input type="text" name="father_middle_name" id="father_middle_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="father_last_name">Last Name:</label>
            <input type="text" name="father_last_name" id="father_last_name" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="father_place_of_birth" id="father_place_of_birth" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            <label for="father_residence">Principal Residence:</label>
            <input type="text" name="father_residence" id="father_residence" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            <label for="father_phone">Phone number:</label>
            <input type="tel" name="father_phone" id="father_phone" required pattern="<?=PHONE_REGEX;?>">
            ...
            <input type="text" name="father_citizenship" id="father_citizenship" required maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <br>
        </fieldset>
        ...
        <input type="text" name="declarant_first_name" id="declarant_first_name" maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="declarant_middle_name">Middle Name:</label>
        <input type="text" name="declarant_middle_name" id="declarant_middle_name" maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="declarant_last_name">Last Name:</label>
        <input type="text" name="declarant_last_name" id="declarant_last_name" maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
        <label for="declarant_relation_to_child">Relationship to Child (Enter none if you have no relationship to the child)</label>
        <input type="text" name="declarant_relation_to_child" id="declarant_relation_to_child" maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>" placeholder="None">
        ...
        <input type="text" name="declarant_place_of_birth" id="declarant_place_of_birth" maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
        <label for="declarant_residence">Principal Residence:</label>
        <input type="text" name="declarant_residence" id="declarant_residence" maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
        <label for="declarant_phone">Phone number:</label>
        <input type="tel" name="declarant_phone" id="declarant_phone" pattern="<?=PHONE_REGEX;?>">
