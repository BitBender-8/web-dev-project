...
<head>
    ...
    <script defer src="<?=PROJECT_ROOT?>src/public/js/annulment/annulment.js"></script>
    <!-- Styles -->
    ...
    <title>Marraige Annulment Registration Form</title>
</head>
<body>
    ...
    <div id="err-container"></div><div class="content">
        <h1>Marriage Annulment registration form</h1>
<?php
// REMOVE 'true'
if (true || !empty($_SESSION["user_id"])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        ob_start();
        require_once "../includes/annulment/annulment-formhandler.php";
        $output = ob_get_clean();
        echo $output;
    }

    require_once "./annulment-form.php";
} else {
