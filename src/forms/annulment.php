...
<body>
    ...
    <form action="../includes/annulment/annulment-formhandler.php" method="post" enctype='multipart/form-data'>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" id="petitioner_citizenship" name="petitioner_citizenship" required>
            </li>
            <li>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" id="respondent_citizenship" name="respondent_citizenship" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="file" id="annulment_reference" name="annulment_reference"
                    accept="<?=rtrim(implode(',', ALLOWED_UPLOAD_FILE_TYPES), ',')?>" required>
            </li>
            <li>
                <label for="annulment_date">Date of Annulment:</label>
                <input type="date" id="annulment_date" name="annulment_date" required>
            </li>
        </ul>
