    ...
    <form action="/web-dev-project/src/includes/death/death-formhandler.php" method="post" enctype='multipart/form-data'>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" id="deceased_title" name="deceased_title" required
            ...
            <li>
                ...
                <input type="number" id="deceased_age" name="deceased_age" min="0" required>
            </li>
            <li>
                <label for="deceased_citizenship">Country of citizenship:</label>
                <input type="text" id="deceased_citizenship" name="deceased_citizenship" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" id="death_place" name="death_place" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
                <label for="death_cause">Cause of Death (if known):</label>
                <input type="text" id="death_cause" name="death_cause" maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
        ...
        <ul>
            <li>
                ...
                <input type="text" id="declarant_first_name" name="declarant_first_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
                <label for="declarant_middle_name">Middle name:</label>
                <input type="text" id="declarant_middle_name" name="declarant_middle_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
                <label for="declarant_last_name">Last name:</label>
                <input type="text" id="declarant_last_name" name="declarant_last_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="tel" id="declarant_phone" name="declarant_phone" required pattern="<?=PHONE_REGEX;?>">
            </li>
            <li>
                <label for="declarant_residence">Principal Residence:</label>
                <input type="text" id="declarant_residence" name="declarant_residence" required
        ...
        <ul>
            <li>
                ...
                <input type="radio" id="declarant_relation_default" name="declarant_relation" value="" required checked
                    style="display: none;">
                <input type="radio" id="declarant_relation_lived" name="declarant_relation" value="lived_together"
                    required>
            ...
            <li>
                <input type="radio" id="declarant_relation_relative" name="declarant_relation" value="relative"
                    required>
            ...
            <li>
                <input type="radio" id="declarant_relation_neighbor" name="declarant_relation" value="neighbor"
                    required>
                <label for="declarant_relation_neighbor">I am a close neighbor</label>
            </li>
            <li>
                <input type="radio" id="declarant_relation_other" name="declarant_relation" value="other" required>
                ...
                <textarea id="declarant_relation_other_text" name="declarant_relation_other_text" disabled
