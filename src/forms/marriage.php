...
<head>
    ...
    <script defer src="<?=PROJECT_ROOT?>src/public/js/marriage/marriage.js"></script>
    <!-- Styles -->
...
if (!empty($_SESSION["user_id"])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        ob_start();
        require_once "../includes/marriage/marriage-formhandler.php";
        $output = ob_get_clean();
        echo $output;
    }

    require_once "./marriage-form.php";
} else {
