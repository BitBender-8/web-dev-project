...
<body>
    ...
    <form action="../includes/marriage/marriage-formhandler.php" method="post" novalidate>
        ...
        <fieldset>
            ...
            <input type="text" id="spouse1_first_name" name="spouse1_first_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="spouse1_middle_name">Middle name:</label>
            <input type="text" id="spouse1_middle_name" name="spouse1_middle_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="spouse1_last_name">Last name:</label>
            <input type="text" id="spouse1_last_name" name="spouse1_last_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="spouse1_place_of_birth" id="spouse1_place_of_birth" required
            ...
            <input type="tel" id="spouse1_phone" name="spouse1_phone" required pattern="<?=PHONE_REGEX;?>">
            <label for="spouse1_residence">Principal Residence:</label>
            <input type="text" name="spouse1_residence" id="spouse1_residence" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
        </fieldset>
        ...
        <fieldset>
            ...
            <input type="text" id="spouse2_last_name" name="spouse2_last_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="spouse2_place_of_birth" id="spouse2_place_of_birth" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            ...
            <input type="tel" id="spouse2_phone" name="spouse2_phone" required pattern="<?=PHONE_REGEX;?>">
            <label for="spouse2_residence">Principal Residence:</label>
            <input type="text" name="spouse2_residence" id="spouse2_residence" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
        </fieldset>
        <h2>Witnesses</h2>
        <fieldset>
            ...
            <input type="text" id="witness1_first_name" name="witness1_first_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="witness1_middle_name">Middle name:</label>
            <input type="text" id="witness1_middle_name" name="witness1_middle_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="witness1_last_name">Last name:</label>
            <input type="text" id="witness1_last_name" name="witness1_last_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="witness1_citizenship" id="witness1_citizenship" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="witness1_phone">Phone:</label>
            <input type="tel" id="witness1_phone" name="witness1_phone" required pattern="<?=PHONE_REGEX;?>">
            <label for="witness1_residence">Principal Residence:</label>
            <input type="text" name="witness1_residence" id="witness1_residence" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
        </fieldset>
        <fieldset>
            <legend>Witness 2</legend>
            <label for="witness2_first_name">First name:</label>
            <input type="text" id="witness2_first_name" name="witness2_first_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="witness2_middle_name">Middle name:</label>
            <input type="text" id="witness2_middle_name" name="witness2_middle_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="witness2_last_name">Last name:</label>
            <input type="text" id="witness2_last_name" name="witness2_last_name" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <input type="text" name="witness2_citizenship" id="witness2_citizenship" required
                maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            <label for="witness2_phone">Phone:</label>
            <input type="tel" id="witness2_phone" name="witness2_phone" required pattern="<?=PHONE_REGEX;?>">
            <label for="witness2_residence">Principal Residence:</label>
            <input type="text" name="witness2_residence" id="witness2_residence" required
                maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
        </fieldset>
        ...
        <input type="text" name="marriage_place" id="marriage_place" required maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
