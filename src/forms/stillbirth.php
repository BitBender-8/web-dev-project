...
<head>
    ...
    <script defer src="<?=PROJECT_ROOT?>src/public/js/stillbirth/stillbirth.js"></script>
    <!-- Styles -->
    ...
    <title>Stillbirth(Fetal death) Registration Form</title>
</head>
<body>
    ...
    <div id="err-container"></div><div class="content">
        <h1>Stillbirth(Fetal death) registration form</h1>
<?php
// REMOVE 'true'
if (true || !empty($_SESSION["user_id"])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        ob_start();
        require_once "../includes/stillbirth/stillbirth-formhandler.php";
        $output = ob_get_clean();
        echo $output;
    }

    require_once "./stillbirth-form.php";
} else {
