...
<head>
    ...
    <title>Stillbrith Registration Form</title>
</head>
...
<body>
    ...
    <form action="../includes/stillbirth/stillbirth-formhandler.php" method="post" enctype='multipart/form-data'
        novalidate>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="number" id="child_gestational_age_wks" name="child_gestational_age_wks" min="1" max="999"
                    required>
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="date" id="mother_dob" name="mother_dob" min="0" required>
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" id="mother_residence" name="mother_residence" required
                    maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
                <label for="mother_citizenship">Country of citizenship:</label>
                <input type="text" id="mother_citizenship" name="mother_citizenship" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            </li>
            <li>
                <label for="mother_phone">Phone number:</label>
                <input type="tel" id="mother_phone" name="mother_phone" required pattern="<?=PHONE_REGEX;?>">
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" id="father_residence" name="father_residence" maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="tel" id="father_phone" name="father_phone" pattern="<?=PHONE_REGEX;?>">
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="number" id="pregnancy_plurality" name="pregnancy_plurality" required min="1" max="999">
            </li>
            <li>
                <label for="pregnancy_duration">Duration of Pregnancy (in weeks):</label>
                <input type="number" id="pregnancy_duration" name="pregnancy_duration" min="1" max="999" required>
            </li>
            <li>
                <label for="birth_order">
                    If not single birth, specify order (1 if Born First, 2 if Second, 3 if Third, etc.):
                </label>
                <input type="number" id="birth_order" name="birth_order" min="1" max="999">
            </li>
        </ul>
        ...
        <ul>
            <li>
                <input type="checkbox" id="reason_maternal_conditions" name="fetal_death_conditions[]"
            ...
            <li>
                <input type="checkbox" id="reason_placenta_complications" name="fetal_death_conditions[]"
            ...
            <li>
                <input type="checkbox" id="reason_fetal_infection" name="fetal_death_conditions[]"
            ...
            <li>
                <input type="checkbox" id="reason_other_fetal_conditions" name="fetal_death_conditions[]"
        ...
        <ul>
            <li>
                ...
                <input type="text" id="reporter_first_name" name="reporter_first_name"
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>" required>
                <label for="reporter_middle_name">Middle name:</label>
                <input type="text" id="reporter_middle_name" name="reporter_middle_name" required
                    maxlength="<?=INPUT_MAXLENGTH_DEFAULT;?>">
            ...
            <li>
                ...
                <input type="text" id="reporter_residence" name="reporter_residence" required
                    maxlength="<?=INPUT_MAXLENGTH_LONG;?>">
            </li>
            <li>
                <label for="reporter_phone">Phone number:</label>
                <input type="tel" id="reporter_phone" name="reporter_phone" required pattern="<?=PHONE_REGEX;?>">
            </li>
        </ul>
