...
$adoption_labels = [
    // Adopter 1
    'adopter1_first_name' => 'Adopter 1 - First Name',
    'adopter1_middle_name' => 'Adopter 1 - Middle Name',
    'adopter1_last_name' => 'Adopter 1 - Last Name',
    ...
    // Adopter 2
    'adopter2_first_name' => 'Adopter 2 - First Name',
    'adopter2_middle_name' => 'Adopter 2 - Middle Name',
    'adopter2_last_name' => 'Adopter 2 - Last Name',
    ...
    'child_sex' => 'Child - Sex',
    'received_child_from' => 'Child - Fullname of Person or Name of Organization from Whom You Received the Child',
...
/**
 * @var array Uses an associative array to group fields in adoption form by heading then lists fields required under each heading
 */
$required_fields = [
    "adoption" => ["adoption_type", "adopter_category", "adoption_date"],
    "adopter1" => [
        "adopter1_first_name",
        "adopter1_middle_name",
        "adopter1_last_name",
        "adopter1_dob",
        "adopter1_sex",
        "adopter1_birthplace",
...
/**
 * @var array Uses an associative array to relate each dropdown, radio button or checkbox of adoption form to a list of its allowed values.
 */
$selection_controls = [
...
/**
 * @var array Uses an associative array to relate each text field of adoption form to its maximum character length
 */
$text_maxlengths = [
    // Adopter 1
    'adopter1_first_name' => INPUT_MAXLENGTH_DEFAULT,
    'adopter1_middle_name' => INPUT_MAXLENGTH_DEFAULT,
    'adopter1_last_name' => INPUT_MAXLENGTH_DEFAULT,
    ...
    // Adopter 2
    'adopter2_first_name' => INPUT_MAXLENGTH_DEFAULT,
    'adopter2_middle_name' => INPUT_MAXLENGTH_DEFAULT,
    'adopter2_last_name' => INPUT_MAXLENGTH_DEFAULT,
