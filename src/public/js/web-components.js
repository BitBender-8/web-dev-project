const avatarHtml = `
<div id="login-avatar">
    <link rel="stylesheet" href="/src/public/styles/web-components/avatar.css">
...
const navBarHtml = `
<link rel="stylesheet" href="/src/public/styles/web-components/navbar.css">
...
<div id="sidebar">
    <a href="/src/index.php" rel="noopener noreferrer" class="home">Vital Events</a>
    <div class="navitem-container">
        <slot></slot>
    </div>
    <div class="menu-container">
        <login-avatar></login-avatar>
        <a class="report-icon" href="/src/report/report.php">
...
<link href="/src/public/styles/fontawesome/css/all.min.css"
            rel="stylesheet">
<link href="/src/public/styles/web-components/site-footer.css" rel="stylesheet">
<footer>
